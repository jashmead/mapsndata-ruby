...
describe HelpsController do
  ...
  let(:valid_attributes) { { "name" => "HelpName", "title" => "HelpTitle", "description" => "HelpDescription" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested help" do
        ...
        Help.any_instance.should_receive(:update).with({ "name" => "HelpName" })
        put :update, {:id => help.to_param, :help => { "name" => "HelpName" }}, valid_session
      end
